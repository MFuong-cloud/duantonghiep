...
export default function AdminHeader({
  ...
  "/admin/menu-categories": {
    breadcrumb: "Danh mục món",
    title: "Quản lý danh mục món ăn",
  },
  "/admin/menu-items": {
    breadcrumb: "Món ăn / Combo",
    title: "Quản lý món ăn & combo",
  },

  "/admin/ingredients": {
    breadcrumb: "Nguyên liệu & Kho",
    title: "Quản lý nguyên liệu & kho",
  },
  "/admin/branches": {
...
//danh sách tìm kiếm
  const pages = [
    ...
    { name: "Danh mục món", path: "/admin/categories" },
    { name: "Món ăn / Combo", path: "/admin/foods" },
    { name: "Nguyên liệu & Kho", path: "/admin/ingredients" },
    { name: "Chi nhánh", path: "/admin/branches" },
